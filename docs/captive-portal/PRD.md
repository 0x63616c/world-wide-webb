# Captive Portal PRD — guest WiFi onboarding (CC-q002)
...
4. Related but out of scope here: CC-cuuw (P0) — the public dashboard has no auth gate; handled in a separate thread.
...
1. M1 scaffold: CC-q002.1 (app scaffold), CC-q002.2 (CI image job).
2. M2 component library: CC-q002.3 (tokens + fonts), CC-q002.4 (primitives, TDD), CC-q002.5 (Storybook composition).
3. M3 screens + flow: CC-q002.6 (all screens/states), CC-q002.7 (state machine + persistence).
4. M4 backend: CC-q002.8 (schema), CC-q002.9 (portal router), CC-q002.10 (UniFiClient), CC-q002.11 (Resend impl).
5. M5 deploy + network: CC-q002.12 (bosun publishPort), CC-q002.13 (DNS-01 TLS), CC-q002.14 (LAN-only deploy + scoped proxy), CC-q002.15 (UniFi setup + runbook).
6. M6 verification: CC-q002.16 (Playwright E2E in CI), CC-q002.17 (real-device production cutover).
