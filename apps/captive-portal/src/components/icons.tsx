// Icon set + Logo, ported 1:1 from docs/captive-portal/design/components.jsx.
// All icons are decorative (aria-hidden); they inherit color via currentColor
// and size from their container's CSS (the .wwb-* rules in theme.css).

type IconProps = { className?: string };

export function GlobeMark({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
