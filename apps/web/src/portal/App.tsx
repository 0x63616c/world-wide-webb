// Ported 1:1 (state machine + effect wiring) from
// products/captive-portal/apps/frontend/src/App.tsx onto the cc rebuild of
// the flow/effects/screens (SDD track 0, task 2.5).
