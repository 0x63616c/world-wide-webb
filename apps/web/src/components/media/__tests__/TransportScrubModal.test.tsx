/**
 * Tests for TransportScrubModal (CC-51hf.16 / CC-51hf.54).
 *
 ...
 *      instead of scrubber.
 * Shuffle and volume removed — no backend mutations exist (CC-51hf.54).
...
describe("TransportScrubModal — open, streaming playing (A20)", () => {
  ...
  it("does not render shuffle or volume (no backend mutations — CC-51hf.54)", () => {
    const { container } = render(<TransportScrubModal {...baseProps} />);
