...
describe("SoundSystemTileView — group panels (CC-xlyf)", () => {
  ...
  it("marks a multi-room-group coordinator with a blue name and no COORD text (CC-a5rl)", () => {
    render(<SoundSystemTileView {...groupedProps} />);
  ...
  it("does NOT blue-mark a solo room whose memberUuids include a hidden bonded satellite (CC-a5rl)", () => {
  ...
  it("hides the group lock when only one room is active (nothing to gang) (CC-a5rl)", () => {
    const soloActive = [
