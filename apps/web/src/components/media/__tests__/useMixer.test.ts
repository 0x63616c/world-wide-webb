/**
 * Tests for useMixer hook (CC-51hf.14).
 *
...
describe("useMixer — gang-lock algorithm (groupLock)", () => {
  // groupLock gangs rooms sharing the dragged room's coordinatorUuid (CC-ecc2).
...
describe("useMixer — solo fader for coordinator-grouped rooms (CC-ecc2)", () => {
