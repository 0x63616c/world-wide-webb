...
describe("Next12Hours", () => {
  ...
  it("www-z2x: feels-like polyline uses low-contrast rgba stroke (not #6E747D)", () => {
    mockHourlyQuery.mockReturnValue({
      data: SAMPLE_HOURS,
      isLoading: false,
      isError: false,
  ...
  it("www-42i: renders SVG bar rects when data is present (chart actually draws)", () => {
    mockHourlyQuery.mockReturnValue({
      data: SAMPLE_HOURS,
      isLoading: false,
      isError: false,
  ...
  it("www-42i: renders exactly 12 bar rects for 12 data points", () => {
    mockHourlyQuery.mockReturnValue({
      data: SAMPLE_HOURS,
      isLoading: false,
      isError: false,
