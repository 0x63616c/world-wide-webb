...
describe("ControlsTile", () => {
  ...
  // ── CC-7d5b.2.5: flicker hack removed (desired-authoritative backend) ─────────
  describe("CC-7d5b.2.5: no cooldown / steady refetch", () => {
  ...
  // ── CC-59u: fan-toggle no-snap-back (now via desired-authoritative backend) ───
  ...
  describe("CC-59u: fan toggle does not snap back", () => {
    beforeEach(() => {
      mockQueryReturn = {
        data: {
          lamps: { on: false, count: 0, sub: "Off", pending: false },
  ...
  // ── CC-7d5b.3.7: setLampMode (party) wiring + speed ──────────────────────────
  describe("CC-7d5b.3.7: party mode + speed wiring", () => {
