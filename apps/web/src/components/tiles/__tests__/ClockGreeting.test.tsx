...
describe("ClockGreeting", () => {
  ...
  it("CC-882: date line has font-size 18", () => {
    vi.useFakeTimers();
    vi.setSystemTime(new Date("2026-05-29T09:30:00"));
  ...
  it("CC-oi9: AM/PM span has non-negative letter-spacing (not inherited -.05em)", () => {
    vi.useFakeTimers();
    vi.setSystemTime(new Date("2026-05-29T09:30:00"));
  ...
  it("CC-902: seconds ring is rendered based on current seconds", () => {
    vi.useFakeTimers();
