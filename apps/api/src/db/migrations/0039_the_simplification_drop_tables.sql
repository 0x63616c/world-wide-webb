...
DROP TABLE "actual_injection" CASCADE;--> statement-breakpoint
DROP TABLE "injection_check_in" CASCADE;--> statement-breakpoint
DROP TABLE "injection_photo" CASCADE;--> statement-breakpoint
DROP TABLE "injection_vial" CASCADE;--> statement-breakpoint
DROP TABLE "injection_course" CASCADE;--> statement-breakpoint
DROP TABLE "injection_settings" CASCADE;--> statement-breakpoint

-- goals: goal_checkin + goal_schedule FK goal.
DROP TABLE "goal_checkin" CASCADE;--> statement-breakpoint
DROP TABLE "goal_schedule" CASCADE;--> statement-breakpoint
DROP TABLE "goal_vacation" CASCADE;--> statement-breakpoint
DROP TABLE "goal" CASCADE;--> statement-breakpoint

-- scenes: scene_run FKs scene.
DROP TABLE "scene_run" CASCADE;--> statement-breakpoint
DROP TABLE "scene" CASCADE;--> statement-breakpoint

-- deploys (GitHub Actions pipeline + its poll cursor).
DROP TABLE "github_run_log_tail" CASCADE;--> statement-breakpoint
DROP TABLE "github_run" CASCADE;--> statement-breakpoint
DROP TABLE "github_poll_status" CASCADE;--> statement-breakpoint
...
DROP TABLE "portal_authorization" CASCADE;--> statement-breakpoint
DROP TABLE "portal_rate_limit" CASCADE;--> statement-breakpoint

-- hooks: the inbound GitHub App webhook log.
DROP TABLE "incoming_webhook" CASCADE;--> statement-breakpoint

-- notif: Notification Center + its APNs device registrations.
DROP TABLE "notification" CASCADE;--> statement-breakpoint
DROP TABLE "device_push_token" CASCADE;--> statement-breakpoint
...
DROP TABLE "frontend_log" CASCADE;--> statement-breakpoint

-- weight: Withings ingest + its stored OAuth token.
DROP TABLE "weight_measurement" CASCADE;--> statement-breakpoint
DROP TABLE "withings_oauth_token" CASCADE;--> statement-breakpoint
...
DROP TABLE "asc_build_status" CASCADE;--> statement-breakpoint
