...
// `tv` now lives in features/tv, `sound` now lives in features/sound,
// `boothPhotos` now lives in features/booth — are merged in below from the
// generated aggregate (features/_generated/router.gen.ts), so a folded
// feature's tRPC surface joins the app router without a hand-edit here.
