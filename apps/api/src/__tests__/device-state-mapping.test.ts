...
// CC-dnpj: desired must only ever carry the commandable climate fields. A desired
...
describe("mergeDeviceState (climate)", () => {
  it("surfaces LIVE reported ambient/action even when a stale desired carries them (CC-dnpj)", () => {
