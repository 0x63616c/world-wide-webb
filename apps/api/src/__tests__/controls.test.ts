...
describe("getControlsState", () => {
  ...
  it("throws on HA network error (www-355t.30: THROW-on-unavailable)", async () => {
...
describe("toggleControl", () => {
  ...
  it("www-355t.15: toggling the fan fetches climate at most once (no double fetch)", async () => {
    mockIsConfigured.mockReturnValue(true);
    mockDbSelect.mockReturnValue(makeSelectChain([]));
