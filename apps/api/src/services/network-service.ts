...
// ---------------------------------------------------------------------------
// DEMO_NETWORK — stable realistic payload shipped while UniFi is deferred (www-32o).
 ...
 * Returns DEMO_NETWORK when UniFi is not configured (integration is deferred — www-32o).
...
export async function getNetworkStatus(clientOverride?: UnifiClient): Promise<NetworkStatus> {
  // UniFi integration is deferred (www-32o). Until it lands the production path
