...
// Kept for when the live hourly feed replaces DEMO_HOURLY (CC-42i).
...
// real-time hourly source lands. Lives in the backend only (CC-42i).
// ---------------------------------------------------------------------------
...
// real-time hourly source replaces it (CC-42i).
