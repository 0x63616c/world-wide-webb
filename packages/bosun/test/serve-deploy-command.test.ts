...
// CC-fmws: the resident bosun-agent must NOT render the deploy from the
...
describe("buildDeployCommand — fresh-image one-shot deploy (CC-fmws)", () => {
...
describe("runWebhookDeploy — one-shot vs in-process fallback (CC-fmws)", () => {
