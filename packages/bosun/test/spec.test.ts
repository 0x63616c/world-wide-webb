...
describe("service builder", () => {
  ...
  // www-q002.12: a LAN-only service (the captive portal) binds a host port on the
...
describe("postgres builder", () => {
  ...
  it("includes a pg_isready health probe targeting the postgres service over the network", () => {
    ...
    // localhost and always exits 2 (www-hya3). The in-container healthcheck keeps
...
// --- Cloudflare Access builders + spec threading (www-cuuw) -------------------
