/**
 * The events feature's own config slice (Track C fold). A folded feature owns
 ...
 * back onto process.env before any feature is imported) and validates just
 * the keys this feature needs. It never reaches into apps/api's `env`.
 *
