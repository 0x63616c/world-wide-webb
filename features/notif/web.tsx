/**
 * Notification Center tile + detail view (Track C, S1 fold). Face
 * (NotificationCenterTile/View) + the full-page detail
 * (ExpandedNotificationCenterView) live together here; the detail-page WIRING
 * (tab state, mutations) stays in apps/web's tile-detail registry
 * (detail/wiring/notifications.tsx , same precedent as guest-wifi/tv/sound)
 * and imports ExpandedNotificationCenterView from this module.
 */
 ...
 * apps/web/.../detail/wiring/notifications.tsx, which owns the tab state +
 * mutations).
 */
 ...
 * deterministic in stories and tests; the container (apps/web's detail wiring)
 * passes a ticking now.
 */
