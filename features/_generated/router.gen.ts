...
export const featureAppRouter = mergeRouters(acApi, boothApi, ctrlApi, deploysApi, eventsApi, felogsApi, goalsApi, guestWifiApi, injectionsApi, networkApi, notifApi, scenesApi, soundApi, wakesApi, weatherApi, weightApi);
