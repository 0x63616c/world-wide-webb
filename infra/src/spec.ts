 ...
 * web's map-provision (CC-hn1i), which guarantees the basemap exists in the
...
export interface WorkloadSpec {
  ...
  // starts (CC-hn1i). First user: web's map-provision.
...
export interface CronJobSpec {
  ...
  // carry the pull secret or its first scheduled run ImagePullBackOffs (CC-hn1i).
  imagePullSecrets?: string[];
}
