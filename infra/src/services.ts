...
// `pulumi up` (the CC-czg digest-pin property, now driven by Pulumi config
 ...
 *   (HA) at the cutover (CC-j934.9 / DESIGN §7 step 3).
...
export function serviceSpecs(opts: ServiceSpecOptions): WorkloadSpec[] {
  ...
  return [
    ...
    },
    {
      ...
      // does not hold the live tunnel token alongside Swarm (CC-j934.9 / §7).
