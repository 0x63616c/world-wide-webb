...
// yet (gated on the kiosk iOS TestFlight build, CC-cuuw plan §6); creating them
// is a separate, deliberate `pulumi up` tracked in CC-jhly, NOT this ticket.
//
...
// CF token verification NOTE (CC-j934.2): the admin token
 ...
 * Block floor + dashboard service-token app (tracked separately in CC-jhly).
 */
