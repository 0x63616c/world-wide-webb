...
// ADOPT-ONLY (CC-j934.2): desiredAccessApps() must reproduce the DEPLOYED CF
...
// service-token app are deliberately deferred (CC-cuuw plan §6, tracked in
// CC-jhly) and MUST NOT be declared here.
...
describe("desiredAccessApps", () => {
  ...
  test("does NOT declare the not-yet-built floor or dashboard app (CC-jhly territory)", () => {
