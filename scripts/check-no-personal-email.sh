...
# public, open-source repo (www-4ma / www-twpy). His commit identity is the GitHub
...
if [ ${#violations[@]} -gt 0 ]; then
  ...
  echo "tracked content. Remove it (use the noreply address). See www-twpy / www-4ma." >&2
  exit 1
fi
