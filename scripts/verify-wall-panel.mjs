...
// verifying the panel directly you must pass the service-token headers, exactly as
// the iOS kiosk injects them:
//   CC_PANEL_URL=https://app.worldwidewebb.co \
...
const URL = process.env.CC_PANEL_URL || "https://app.worldwidewebb.co";
const OUT =
