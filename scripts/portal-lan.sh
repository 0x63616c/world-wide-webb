#!/usr/bin/env bash
# LAN-edge proxy for the captive portal (CC-q002.21, HTTPS on :42069 in CC-q002.22).
#
...
# service.
#
# HTTPS ON THE LAN (CC-q002.22): host :443 is ALSO trapped, OrbStack binds it for
