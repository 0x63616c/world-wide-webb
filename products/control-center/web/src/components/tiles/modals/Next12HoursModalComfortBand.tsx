...
const BAND_CONFIG: Record<Band, BandConfig> = {
  ...
  cool: { label: "Cool", color: "var(--acc-dim)", textColor: "var(--acc)" },
  mild: { label: "Mild", color: "var(--acc-soft)", textColor: "var(--acc)" },
                  ...
                  >
                    <div
                      style={{
                        ...
                        background: colder ? "var(--acc-line)" : "rgba(244,192,99,0.5)",
                      }}
                    />
                  </div>
                  {/* Gap label */}
