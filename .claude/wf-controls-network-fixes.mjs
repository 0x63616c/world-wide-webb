...
- ZERO fake/placeholder data except the two already-sanctioned backend demo files (products/control-center/api/src/services/network-service.ts, products/control-center/api/src/services/weather-service.ts). A blocking pre-commit hook (scripts/check-fake-data.sh) rejects FALLBACK/PLACEHOLDER and new DEMO_ elsewhere , do not trip it.
