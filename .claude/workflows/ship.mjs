...
// args (all optional):
//   issue        bd issue/epic id this run delivers (e.g. "CC-xxx")
...
- Commit with the format the commit-msg guard REQUIRES: \`type(area/CC-xxx): desc\` — a conventional type (feat/fix/refactor/chore/test/docs/ci/build) whose scope carries an area AND the bd ticket id, e.g. \`feat(web/tiles/CC-m9k): add poller\`. A bare \`feat: ...\` is rejected. Keep commits small and focused. Do NOT push (Finalize handles push policy).
