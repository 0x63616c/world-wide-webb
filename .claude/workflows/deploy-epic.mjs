...
const AC = [
  { t: 'CC-5ag.1', k: 'ac_tool_build', phase: 'ToolValidate' },
  { t: 'CC-5ag.3', k: 'ac_tool_plan_pure', phase: 'ToolValidate' },
  { t: 'CC-5ag.4', k: 'ac_tool_providers', phase: 'ToolValidate' },
  { t: 'CC-5ag.7', k: 'ac_tool_health', phase: 'ToolValidate' },
  { t: 'CC-5ag.22', k: 'ac_config_pure', phase: 'ToolValidate' },
  { t: 'CC-5ag.10', k: 'ac_gates', phase: 'Gates' },
  { t: 'CC-5ag.2', k: 'ac_images', phase: 'CI' },
  { t: 'CC-5ag.9', k: 'ac_ci_selective', phase: 'CI' },
  { t: 'CC-5ag.8', k: 'ac_tool_up', phase: 'Deploy' },
  { t: 'CC-5ag.11', k: 'ac_stack_up', phase: 'Deploy' },
  { t: 'CC-5ag.12', k: 'ac_healthchecks', phase: 'Deploy' },
  { t: 'CC-5ag.5', k: 'ac_tool_secret_sync_prune', phase: 'Deploy' },
  { t: 'CC-5ag.6', k: 'ac_tool_routes_sync_prune', phase: 'Deploy' },
  { t: 'CC-5ag.13', k: 'ac_portainer_https', phase: 'Deploy' },
  { t: 'CC-5ag.14', k: 'ac_portainer_login', phase: 'Deploy', gate: true },
  { t: 'CC-5ag.15', k: 'ac_storybook', phase: 'Deploy' },
  { t: 'CC-5ag.16', k: 'ac_tunnel', phase: 'Deploy' },
  { t: 'CC-5ag.17', k: 'ac_dashboard_render', phase: 'App' },
  { t: 'CC-5ag.18', k: 'ac_live_ha', phase: 'App' },
  { t: 'CC-5ag.19', k: 'ac_no_secrets_git', phase: 'Security' },
  { t: 'CC-5ag.20', k: 'ac_no_inbound', phase: 'Security' },
  { t: 'CC-5ag.21', k: 'ac_api_private', phase: 'Security' },
  { t: 'CC-5ag.23', k: 'ac_pg_persists', phase: 'Resilience' },
  { t: 'CC-5ag.24', k: 'ac_restart_recovers', phase: 'Resilience' },
  { t: 'CC-5ag.25', k: 'ac_autostart', phase: 'Resilience', gate: true },
  { t: 'CC-5ag.26', k: 'ac_config_speed', phase: 'Lifecycle' },
  { t: 'CC-5ag.27', k: 'ac_code_auto', phase: 'Lifecycle', gate: true },
  { t: 'CC-5ag.28', k: 'ac_rollback', phase: 'Lifecycle' },
  { t: 'CC-5ag.29', k: 'ac_main_clean', phase: 'Capstone' },
]
