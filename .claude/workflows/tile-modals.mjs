...
const REPO = `
PROJECT: control-center , a smart-home wall-panel dashboard, FIXED 1366x1024 (iPad Pro). products/control-center/web = React board, products/control-center/api = tRPC backend.
...
- products/control-center/web/src/components/ui/Modal.tsx , shared overlay. Props: { open, onClose, title, children, width?, maxHeight? }. width/maxHeight default to 640/720 but ARE TUNABLE PER MODAL (clamped to 1280x960). Size each tile's modal to its concept , a wide map can be 980+, a narrow agenda can stay 560. Body scrolls (.modal-scroll).
- products/control-center/web/src/components/tiles/ExpandedControlsModalView.tsx , the gold-standard expanded modal. PURE view: ALL data + callbacks arrive via props, NO trpc/hooks. Composes trivially in Storybook + tests.
- products/control-center/web/src/components/tiles/ExpandedControlsModalView.stories.tsx , story shape (title "Modals/...", fixtures, fn() callbacks).
- products/control-center/web/src/components/tiles/TileShowcaseModal.tsx , the generic container the board currently opens on tap (renders the live tile at production size). The new detail modals will REPLACE/augment this per tile at implementation time. POCs do NOT wire into the board.
...
- Reuse shared primitives from products/control-center/web/src/components/ui/ (barrel: ui/index.ts): TileHeader, Stat, Pill, Chip, Skeleton, ControlTap, StatusDot, BorderProgressRing, Modal. Do NOT re-inline headers/pills/skeletons.
- Styling: dark theme via CSS custom props in products/control-center/web/src/styles/tokens.css (--bg --tile --tile-2 --nest --hair --hair-2 --ink --ink-2 --ink-3 --acc --amber --r --ui --mono, helper classes .cap .sec .pill .chip .range .feed .divider). Use these tokens, never raw hex.
...
const TILES = [
  {
    ...
    label: 'Clock',
    files: [
      'products/control-center/web/src/components/tiles/ClockGreeting.tsx',
      'products/control-center/web/src/components/tiles/ClockGreetingView.tsx',
      'products/control-center/web/src/components/tiles/ClockSecondsRing.tsx',
      'products/control-center/web/src/components/tiles/ClockGreetingView.stories.tsx',
    ],
  ...
  },
  {
    ...
    label: 'Weather',
    files: [
      'products/control-center/web/src/components/tiles/WeatherNow.tsx',
      'products/control-center/web/src/components/tiles/WeatherNowView.tsx',
      'products/control-center/web/src/components/tiles/WeatherNowView.stories.tsx',
      'products/control-center/api/src/trpc/routers/weather.ts',
      'products/control-center/api/src/services/weather-service.ts',
    ],
  ...
  },
  {
    ...
    label: 'Network',
    files: [
      'products/control-center/web/src/components/tiles/NetworkTile.tsx',
      'products/control-center/web/src/components/tiles/NetworkTileView.tsx',
      'products/control-center/web/src/components/tiles/NetworkTileView.stories.tsx',
      'products/control-center/api/src/trpc/routers/network.ts',
      'products/control-center/api/src/services/network-service.ts',
      'products/control-center/api/src/integrations/unifi/index.ts',
    ],
  ...
  },
  {
    ...
    label: 'Tesla',
    files: [
      'products/control-center/web/src/components/tiles/TeslaTile.tsx',
      'products/control-center/web/src/components/tiles/TeslaTileView.tsx',
      'products/control-center/web/src/components/tiles/TeslaMap.tsx',
      'products/control-center/web/src/components/tiles/TeslaTileView.stories.tsx',
      'products/control-center/api/src/trpc/routers/tesla.ts',
      'products/control-center/api/src/services/tesla-service.ts',
    ],
  ...
  },
  {
    ...
    label: 'Next 12 Hours',
    files: [
      'products/control-center/web/src/components/tiles/Next12Hours.tsx',
      'products/control-center/web/src/components/tiles/Next12HoursView.tsx',
      'products/control-center/web/src/components/tiles/Next12HoursView.stories.tsx',
      'products/control-center/api/src/trpc/routers/weather.ts',
      'products/control-center/api/src/services/weather-service.ts',
    ],
  ...
  },
  {
    ...
    label: 'Climate',
    files: [
      'products/control-center/web/src/components/tiles/ClimateTile.tsx',
      'products/control-center/web/src/components/tiles/ClimateTileView.tsx',
      'products/control-center/web/src/components/tiles/ClimateTileView.stories.tsx',
      'products/control-center/api/src/trpc/routers/climate.ts',
      'products/control-center/api/src/services/climate-service.ts',
    ],
  ...
  },
  {
    ...
    label: 'Events',
    files: [
      'products/control-center/web/src/components/tiles/EventsTile.tsx',
      'products/control-center/web/src/components/tiles/EventsTileView.tsx',
      'products/control-center/web/src/components/tiles/EventsTileView.stories.tsx',
      'products/control-center/api/src/trpc/routers/events.ts',
      'products/control-center/api/src/services/events-service.ts',
    ],
...
Also skim the relevant Home Assistant integration if data origin is unclear (products/control-center/api/src/integrations/).
...
function buildPrompt(t, idea, realData) {
  ...
  const componentFile = `products/control-center/web/src/components/tiles/modals/${comp}.tsx`
  const storyFile = `products/control-center/web/src/components/tiles/modals/${comp}.stories.tsx`
  return `${REPO}
...
Reference the gold-standard modal before writing: products/control-center/web/src/components/tiles/ExpandedControlsModalView.tsx and its .stories.tsx. Match that structure EXACTLY:
...
STEP , VERIFY before returning (required): run
  bunx biome check --write products/control-center/web/src/components/tiles/modals/${comp}.tsx products/control-center/web/src/components/tiles/modals/${comp}.stories.tsx
  bun run typecheck
